...
const PatientRegister = ({empId}) => {
  ...
  function onSubmit(e: any) {
    ...
    postPatientRegister(data).then((data) => {
      router.push(`/${empId}/view?patientId=${data}`);
    });
  }
    ...
    <>
      ...
      <div className="  flex items-center justify-center rounded-xl px-8 py-2">
        <div className="container mx-auto border-4 rounded-2xl p-12">
          ...
          <form onSubmit={(e) => onSubmit(e)} className=" mx-auto p-5 border-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="col-span-2 my-4 border-b">
                <button
                  onClick={(e) => {e.preventDefault(); toggleAccordion("patientInfo");}}
              ...
              <div className="col-span-2 my-4 border-b">
                <button
                  onClick={(e) => {e.preventDefault(); toggleAccordion("patientFamDoctor")}}
                  className="w-full p-4 shadow-lg text-left flex items-center justify-between rounded-lg text-2xl font-semibold mb-2"
                >
                  Family Doctor
              ...
              <div className="col-span-2 my-4 border-b mb-6">
                <button
                  onClick={(e) => {e.preventDefault(); toggleAccordion("nextOfKin")}}
                  className="w-full p-4 shadow-lg text-left flex items-center justify-between rounded-lg text-2xl font-semibold mb-2"
                >
                  Next of Kin
                  {!(openStep === "nextOfKin") ? (
