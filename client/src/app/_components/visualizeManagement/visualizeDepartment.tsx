...
const EmployeeCountComp = ({ position, Icon }) => {
  return (
            ...
            <div className="flex-grow w-full lg:w-9/12 p-4 relative items-center bg-white border-secondary border-4 shadow-lg rounded-2xl overflow-hidden">
              <div className="container mx-auto py-4">
                ...
                <div className="flex-grow overflow-hidden">
                  <RequestListController department={divisionName} />
                </div>
              </div>
            </div>

            <div className="w-full lg:w-2/12 flex flex-col space-y-4">
              <EmployeeCountComp position="doctor" Icon={DoctorIcon} />
              <EmployeeCountComp position="nurse" Icon={NurseIcon} />
              <EmployeeCountComp
